...
{
  /// <summary>
  /// Description of RfiIndexTable.
  /// </summary>
  public sealed class RfiIndexTable  : FileIndex, IFilter
  {

    // with the static keyword on the constructor this should
    // keep the object in memory for the lifetime of the application
    private static readonly Lazy<RfiIndexTable> lazy =
      new Lazy<RfiIndexTable>(() => new RfiIndexTable());

    private static object synclock = new object();

    public static RfiIndexTable Index { get { return lazy.Value; } }
